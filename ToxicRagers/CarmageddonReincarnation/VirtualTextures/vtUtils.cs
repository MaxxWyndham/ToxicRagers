...
namespace ToxicRagers.CarmageddonReincarnation.VirtualTextures
{
    ...
    public class vtUtils
    {
        ...
        public VirtualTextureDef LoadVT(string inputFolder)
        {
            ...
            vtDef.DiffuseMap = (VTMap)DiffuseTDX.ExtraData;

            vtDef.SpecularMap = (VTMap)SpecularTDX.ExtraData;

            vtDef.NormalMap = (VTMap)NormalTDX.ExtraData;

            vtDef.DiffusePages = new List<VTPage>();
